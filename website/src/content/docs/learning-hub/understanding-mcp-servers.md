...
| File | Scope | Notes |
|------|-------|-------|
| `.github/mcp.json` | Repository root | Auto-loaded workspace config; ideal for team-shared servers (v1.0.61+) |
| `.mcp.json` | Repository root | Also auto-loaded; preferred for repo-shared configuration |
