...
> **Tool filters in subagents**: When a custom agent launches subagents, those subagents automatically inherit and respect the parent agent's tool restrictions. This ensures that security boundaries and tool access policies defined in your agent are preserved throughout nested subagent calls.
...
| Specialized code tasks | kimi-k2.7-code |
