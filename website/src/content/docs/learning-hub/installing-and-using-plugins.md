...
| **Extensions** | Installable IDE/CLI extensions bundled with the plugin | `extensions/` |
...
- **Extensions** are installed automatically and become immediately active — no separate install step required
