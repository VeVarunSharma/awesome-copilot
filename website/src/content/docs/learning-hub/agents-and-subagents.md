...
> **Note (v1.0.72+)**: Multi-turn subagents are always enabled in Copilot CLI, meaning you can send follow-up messages to a running subagent without any additional configuration.
