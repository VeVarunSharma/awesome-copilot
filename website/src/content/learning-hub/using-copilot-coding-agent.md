...
> **Note**: The personal skills directory is `~/.agents/skills/`, which aligns with the default used by the GitHub Copilot extension for VS Code. This was updated in Copilot CLI v1.0.11.
