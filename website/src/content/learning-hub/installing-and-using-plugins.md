...
> **Configuration note**: If you configure extra marketplaces via the CLI settings file, use the `extraKnownMarketplaces` key. The older `marketplaces` key was removed in v1.0.16.
